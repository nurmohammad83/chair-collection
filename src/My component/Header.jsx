...
const Header = () => {
	...
	<div className="container flex justify-between h-16 mx-auto">
		...
		<ul className="items-stretch hidden space-x-3 md:flex">
			<li className="flex">
				<Link rel="noopener noreferrer" to='/' className="flex items-center px-4 hover:border-orange-400 mb-1 border-b-2 dark:border-transparent">Home</Link>
			</li>
			<li className="flex">
				<Link rel="noopener noreferrer" to='/products' className="flex hover:border-orange-400 items-center px-4 mb-1 border-b-2 dark:border-transparent">Prodoucts</Link>
			</li>
			<li className="flex">
				<Link rel="noopener noreferrer" to='/cart' className="flex items-center px-4 mb-1 border-b-2 hover:border-orange-400 dark:border-transparent dark:text-violet-400 dark:border-violet-400">
					<div className='relative'>
						<FontAwesomeIcon icon={faShoppingCart}/>
						<p className='absolute bottom-3 left-5'>{cart.length}</p>
					</div>
					
					</Link>
			</li>
			<li className="flex">
				<Link rel="noopener noreferrer" to='/profile' className="flex items-center px-4 mb-1 border-b-2 dark:border-transparent hover:border-orange-400">Profile</Link>
			</li>
			<li className="flex">
				<Link rel="noopener noreferrer" to='/about' className="flex items-center px-4 mb-1 border-b-2 dark:border-transparent hover:border-orange-400">About</Link>
			</li>
